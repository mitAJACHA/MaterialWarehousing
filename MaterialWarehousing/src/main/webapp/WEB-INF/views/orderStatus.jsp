							...
							<div class="table-overflow">
								<form action="search" method="post" style="margin-bottom: 0px">
									<table class="table table-lg">
										<tr>
											<th>회사명&nbsp;&nbsp;<input type="text" id="form-control" name="companyName"></th>
											<th>품목명&nbsp;&nbsp;<input type="text" id="form-control" name="partName"></th>
											<th>일자&nbsp;&nbsp; 
												<input type="date" id="form-control" name="startDate">
												&nbsp; ~ &nbsp;
												<input type="date" id="form-control" name="endDate">
											</th>
											<th>
